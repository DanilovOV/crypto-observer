...
const API_KEY =
	'5f9886c3c60cd3cea843b575c53f4fe48370405c6ba03ce2bb59fce9fd465064'
const tickersHandlers = new Map()

let tab
let tabDefineResolve
const tabDefinePromise = new Promise((resolve) => {
	tabDefineResolve = resolve
})
...
const tabInit = async () => {
	...
	tab = tabFactory.createTab(tabType, {
		apiKey: API_KEY,
		tickersHandlers,
		tabsSyncWorker: worker,
	})
	tabDefineResolve()
}
...
export const getCoinsData = callAfterInit(async () => await tab.getCoinsData())
